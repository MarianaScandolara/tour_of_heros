...
```bash
# clonar o projeto
git clone https://github.com/MarianaScandolara/tour_of_heros.git
...
Para navegar no projeto em produção acesse [https://tuor-of-heros-mvc.herokuapp.com](https://tuor-of-heros-mvc.herokuapp.com/)
